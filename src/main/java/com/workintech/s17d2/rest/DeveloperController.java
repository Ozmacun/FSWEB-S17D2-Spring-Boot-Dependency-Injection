...
public class DeveloperController {
    ...
    public void init() {
        ...
        this.developers.put(1,new SeniorDeveloper(1,"Tolga",2000d));
    }
    ...
    public DeveloperResponse getById(@PathVariable("id") int id) {
        ...
        if(foundDeveloper == null){
            return new DeveloperResponse(null, HttpStatus.NOT_FOUND.value(), id + "ile search yapıldı ve kayıt bulunamadı");
        }
